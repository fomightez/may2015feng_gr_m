...
master_doc = 'index'
project = u'FengLabWkshopMay2015' # If you have the `conf.py` file but comment this out, it will title the docs `Python` it seems. But if you delete `conf.py` all together it will ise the title you set in the read the docs set-up but will not have copyright names.
